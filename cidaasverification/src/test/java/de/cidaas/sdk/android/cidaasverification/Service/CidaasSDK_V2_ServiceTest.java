package de.cidaas.sdk.android.cidaasverification.Service;
 ...
 * string.
 */
public class CidaasSDK_V2_ServiceTest {
    ...
    public void testSanitizeUserAgent_preservesAsciiCharacters() {
        String input = "Cidaas-com.cidaas.test/4.0.0 Make:Google_Pixel Model:Pixel5";
        String result = sanitizeForUserAgent(input);
